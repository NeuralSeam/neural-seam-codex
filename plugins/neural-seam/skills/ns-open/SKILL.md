---
name: ns-open
description: "Neural Seam: mostra o link do dashboard/bridge local (a SPA ja abre escopada ao projeto deste diretorio). Ative quando o dev quiser abrir o dashboard, o kanban ou a UI do Neural Seam, ou pedir $neural-seam:ns-open."
---
